...
## 📈 Actualizaciones del Sistema (Educación & Experiencia)

| Versión | Hito | Fecha |
|---------|------|-------|
| **v2.0** | 🎓 Técnico Laboral en Desarrollo de Software | IETDH Medical Duarte, 2025 |
| **v1.0** | 🚀 Inicio en Desarrollo de Software | 2024 |
...
### 🔗 [LogiTrack](https://github.com/JhonierQuintero/LogiTrack_SprinBoot)
Sistema de Gestión de Inventario y Bodegas con Spring Boot + PostgreSQL

**Stack:** Java | Spring Boot | PostgreSQL | JWT | REST API

---

### 🎯 Otras Colaboraciones
Múltiples proyectos en desarrollo, análisis y optimización
